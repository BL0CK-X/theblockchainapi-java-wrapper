...
/**
 * API tests for CcPaymentApi
 */
@Ignore
public class CcPaymentApiTest {

    private final CcPaymentApi api = new CcPaymentApi();
     ...
     */
    @Test
    public void getCCPaymentTest() throws ApiException {
        String projectId = null;
        String paymentIdentifier = null;
                CCPayment response = api.getCCPayment(projectId, paymentIdentifier);
     ...
     */
    @Test
    public void listAllCCPaymentsTest() throws ApiException {
                List<CCPayment> response = api.listAllCCPayments();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void listCCProjectPaymentsTest() throws ApiException {
        String projectId = null;
         UNKNOWN_PARAMETER_NAME = null;
                List<CCPayment> response = api.listCCProjectPayments(projectId, UNKNOWN_PARAMETER_NAME);
        // TODO: test validations
    }
