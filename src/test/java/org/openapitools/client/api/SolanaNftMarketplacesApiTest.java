...
/**
 * API tests for SolanaNftMarketplacesApi
 */
@Ignore
public class SolanaNftMarketplacesApiTest {

    private final SolanaNftMarketplacesApi api = new SolanaNftMarketplacesApi();
     ...
     */
    @Test
    public void solanaBuyNFTFromSolSeaTest() throws ApiException {
        String network = null;
        String mintAddress = null;
        UNKNOWN_BASE_TYPE UNKNOWN_BASE_TYPE = null;
                InlineResponse2001 response = api.solanaBuyNFTFromSolSea(network, mintAddress, UNKNOWN_BASE_TYPE);
     ...
     */
    @Test
    public void solanaDelistNFTFromSolSeaTest() throws ApiException {
        String network = null;
        String mintAddress = null;
        UNKNOWN_BASE_TYPE UNKNOWN_BASE_TYPE = null;
                InlineResponse2003 response = api.solanaDelistNFTFromSolSea(network, mintAddress, UNKNOWN_BASE_TYPE);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void solanaGetNFTListingTest() throws ApiException {
        String network = null;
        String mintAddress = null;
                InlineResponse200 response = api.solanaGetNFTListing(network, mintAddress);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void solanaListNFTOnSolSeaTest() throws ApiException {
        String network = null;
        String mintAddress = null;
        UNKNOWN_BASE_TYPE UNKNOWN_BASE_TYPE = null;
                InlineResponse2002 response = api.solanaListNFTOnSolSea(network, mintAddress, UNKNOWN_BASE_TYPE);
        // TODO: test validations
    }
