...
/**
 * API tests for SolanaSplTokenApi
 */
@Ignore
public class SolanaSplTokenApiTest {

    private final SolanaSplTokenApi api = new SolanaSplTokenApi();
     ...
     */
    @Test
    public void solanaGetSPLTokenTest() throws ApiException {
        String publicKey = null;
        String network = null;
                GetSPLTokenResponse response = api.solanaGetSPLToken(publicKey, network);
