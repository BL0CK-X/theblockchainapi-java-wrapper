...
/**
 * API tests for NameServiceApi
 */
@Ignore
public class NameServiceApiTest {

    private final NameServiceApi api = new NameServiceApi();
     ...
     */
    @Test
    public void getBlockchainIdentifierFromNameTest() throws ApiException {
        String blockchain = null;
        String network = null;
        InputName inputName = null;
                InputBlockchainIdentifier response = api.getBlockchainIdentifierFromName(blockchain, network, inputName);
     ...
     */
    @Test
    public void getNameForBlockchainIdentifierTest() throws ApiException {
        String blockchain = null;
        String network = null;
        String blockchainIdentifier = null;
        InputBlockchainIdentifier inputBlockchainIdentifier = null;
                InputName response = api.getNameForBlockchainIdentifier(blockchain, network, blockchainIdentifier, inputBlockchainIdentifier);
        // TODO: test validations
    }
