...
public class TokenApiTest {
    ...
    public void getTokenMetadataTest() throws ApiException {
        ...
        String network = null;
        String tokenBlockchainIdentifier = null;
                TokenMetadataResponse response = api.getTokenMetadata(blockchain, network, tokenBlockchainIdentifier);
     ...
     */
    @Test
    public void listAllTokensTest() throws ApiException {
        String blockchain = null;
        String network = null;
                List<TokenMetadataResponse> response = api.listAllTokens(blockchain, network);
        // TODO: test validations
    }
