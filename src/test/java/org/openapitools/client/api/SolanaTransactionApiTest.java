...
/**
 * API tests for SolanaTransactionApi
 */
@Ignore
public class SolanaTransactionApiTest {

    private final SolanaTransactionApi api = new SolanaTransactionApi();
     ...
     */
    @Test
    public void solanaGetTransactionTest() throws ApiException {
        String network = null;
        String txSignature = null;
                Transaction response = api.solanaGetTransaction(network, txSignature);
