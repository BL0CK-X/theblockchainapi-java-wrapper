...
/**
 * API tests for SolanaAccountApi
 */
@Ignore
public class SolanaAccountApiTest {

    private final SolanaAccountApi api = new SolanaAccountApi();
     ...
     */
    @Test
    public void solanaGetAccountTest() throws ApiException {
        String network = null;
        String publicKey = null;
                Account response = api.solanaGetAccount(network, publicKey);
     ...
     */
    @Test
    public void solanaGetAccountIsCandyMachineTest() throws ApiException {
        String network = null;
        String publicKey = null;
                AccountIsCandyMachine response = api.solanaGetAccountIsCandyMachine(network, publicKey);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void solanaGetAccountIsNFTTest() throws ApiException {
        String network = null;
        String publicKey = null;
                AccountIsNFT response = api.solanaGetAccountIsNFT(network, publicKey);
        // TODO: test validations
    }
