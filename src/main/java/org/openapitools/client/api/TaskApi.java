...
public class TaskApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Task completed. Does *NOT* indicate that the task was successful. Check the response data for details. </td><td>  -  </td></tr>
        <tr><td> 202 </td><td> Task in Progress. Check back again in a bit! </td><td>  -  </td></tr>
    ...
    private okhttp3.Call getTaskValidateBeforeCall(String taskId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getTaskCall(taskId, _callback);
        return localVarCall;
