...
public class SolanaNftApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 502 </td><td> Service unavailable. This can happen when Solana&#39;s leading validator is behind and is unable to process transactions we send. We have no control over this. The proper response here is to wait 10 or so seconds and try again. </td><td>  -  </td></tr>
     </table>
     */
