...
import org.openapitools.client.model.GetSPLTokenResponse;
...
public class SolanaSplTokenApi {
    ...
    public SolanaSplTokenApi(ApiClient apiClient) {
    ...
    /**
     * Build call for solanaGetSPLToken
     * @param publicKey The public key of the token (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 404 </td><td> Account not found / not initialized with this public key address. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call solanaGetSPLTokenCall(String publicKey, String network, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/solana/spl-token/{network}/{public_key}"
    ...
    private okhttp3.Call solanaGetSPLTokenValidateBeforeCall(String publicKey, String network, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'publicKey' is set
        if (publicKey == null) {
            throw new ApiException("Missing the required parameter 'publicKey' when calling solanaGetSPLToken(Async)");
        }
        
        // verify the required parameter 'network' is set
        if (network == null) {
            throw new ApiException("Missing the required parameter 'network' when calling solanaGetSPLToken(Async)");
        }
        

        okhttp3.Call localVarCall = solanaGetSPLTokenCall(publicKey, network, _callback);
        return localVarCall;
     ...
     */
    public GetSPLTokenResponse solanaGetSPLToken(String publicKey, String network) throws ApiException {
        ApiResponse<GetSPLTokenResponse> localVarResp = solanaGetSPLTokenWithHttpInfo(publicKey, network);
     ...
     */
    public ApiResponse<GetSPLTokenResponse> solanaGetSPLTokenWithHttpInfo(String publicKey, String network) throws ApiException {
        okhttp3.Call localVarCall = solanaGetSPLTokenValidateBeforeCall(publicKey, network, null);
        Type localVarReturnType = new TypeToken<GetSPLTokenResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get SPL token metadata (asynchronously)
     * &lt;a href&#x3D;\&quot;https://github.com/BL0CK-X/the-blockchain-api/tree/main/examples/solana-spl-token/get-spl-token\&quot; target&#x3D;\&quot;_blank\&quot;&gt;See examples (Python, JavaScript)&lt;/a&gt;.  Retrieves basic information about an SPL token given its &#x60;mint_address&#x60;.  You can see the mint addresses of popular SPL tokens &lt;a href&#x3D;\&quot;https://raw.githubusercontent.com/solana-labs/token-list/main/src/tokens/solana.tokenlist.json\&quot; target&#x3D;\&quot;_blank\&quot;&gt;here&lt;/a&gt;.  Some example mint addresses of SPL tokens: - USDC: EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v - Mango: MangoCzJ36AjZyKwVj3VnYU4GTonjfVEnJmvvWaxLac - Serum: SRMuApVNdxXokk5GT7XD5cUUgXMBCoAz2LHeuAoKWRt - Raydium: 4k3Dyjzvzp8eMZWUXbBCjEvwSkkk59S5iCNLY3QrkX6R - wSOL: So11111111111111111111111111111111111111112 - ATLAS: ATLASXmbPQxBUYbxPsV97usA3fPQYEqzQBUHgiFCUsXx  &#x60;Cost: 1 Credit&#x60; (&lt;a href&#x3D;\&quot;#section/Pricing\&quot;&gt;See Pricing&lt;/a&gt;)
     * @param publicKey The public key of the token (required)
     * @param network The network ID (devnet, mainnet-beta) (required)
     ...
     */
    public okhttp3.Call solanaGetSPLTokenAsync(String publicKey, String network, final ApiCallback<GetSPLTokenResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = solanaGetSPLTokenValidateBeforeCall(publicKey, network, _callback);
        Type localVarReturnType = new TypeToken<GetSPLTokenResponse>(){}.getType();
