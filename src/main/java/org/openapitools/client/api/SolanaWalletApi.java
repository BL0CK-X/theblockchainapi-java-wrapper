...
public class SolanaWalletApi {
    ...
    /**
     * Build call for solanaDerivePrivateKey
     ...
     */
    public okhttp3.Call solanaDerivePrivateKeyCall(GetPublicKeyRequest getPublicKeyRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        ...
        // create path and map variables
        String localVarPath = "/solana/wallet/private_key";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call solanaDerivePrivateKeyValidateBeforeCall(GetPublicKeyRequest getPublicKeyRequest, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'getPublicKeyRequest' is set
        if (getPublicKeyRequest == null) {
            throw new ApiException("Missing the required parameter 'getPublicKeyRequest' when calling solanaDerivePrivateKey(Async)");
        }
        

        okhttp3.Call localVarCall = solanaDerivePrivateKeyCall(getPublicKeyRequest, _callback);
        return localVarCall;
     ...
     */
    public GeneratePrivateKey solanaDerivePrivateKey(GetPublicKeyRequest getPublicKeyRequest) throws ApiException {
        ApiResponse<GeneratePrivateKey> localVarResp = solanaDerivePrivateKeyWithHttpInfo(getPublicKeyRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GeneratePrivateKey> solanaDerivePrivateKeyWithHttpInfo(GetPublicKeyRequest getPublicKeyRequest) throws ApiException {
        okhttp3.Call localVarCall = solanaDerivePrivateKeyValidateBeforeCall(getPublicKeyRequest, null);
        Type localVarReturnType = new TypeToken<GeneratePrivateKey>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call solanaDerivePrivateKeyAsync(GetPublicKeyRequest getPublicKeyRequest, final ApiCallback<GeneratePrivateKey> _callback) throws ApiException {

        okhttp3.Call localVarCall = solanaDerivePrivateKeyValidateBeforeCall(getPublicKeyRequest, _callback);
        Type localVarReturnType = new TypeToken<GeneratePrivateKey>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Build call for solanaGeneratePrivateKey
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call solanaGeneratePrivateKeyCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        ...
        // create path and map variables
        String localVarPath = "/solana/wallet/generate/private_key";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call solanaGeneratePrivateKeyValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = solanaGeneratePrivateKeyCall(_callback);
        return localVarCall;
     ...
     */
    public GeneratePrivateKey solanaGeneratePrivateKey() throws ApiException {
        ApiResponse<GeneratePrivateKey> localVarResp = solanaGeneratePrivateKeyWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GeneratePrivateKey> solanaGeneratePrivateKeyWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = solanaGeneratePrivateKeyValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<GeneratePrivateKey>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call solanaGeneratePrivateKeyAsync(final ApiCallback<GeneratePrivateKey> _callback) throws ApiException {

        okhttp3.Call localVarCall = solanaGeneratePrivateKeyValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<GeneratePrivateKey>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public okhttp3.Call solanaGenerateSecretRecoveryPhraseCall(final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/solana/wallet/generate/secret_recovery_phrase";
    ...
    /**
     * Build call for solanaGetWalletTransactions
     * @param network The network ID (devnet, mainnet-beta) (required)
     * @param publicKey The public key of the account whose list of signatures you want to get (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call solanaGetWalletTransactionsCall(String network, String publicKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        ...
        // create path and map variables
        String localVarPath = "/solana/wallet/{network}/{public_key}/transactions"
            .replaceAll("\\{" + "network" + "\\}", localVarApiClient.escapeString(network.toString()))
            .replaceAll("\\{" + "public_key" + "\\}", localVarApiClient.escapeString(publicKey.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call solanaGetWalletTransactionsValidateBeforeCall(String network, String publicKey, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'network' is set
        if (network == null) {
            throw new ApiException("Missing the required parameter 'network' when calling solanaGetWalletTransactions(Async)");
        }
        
        // verify the required parameter 'publicKey' is set
        if (publicKey == null) {
            throw new ApiException("Missing the required parameter 'publicKey' when calling solanaGetWalletTransactions(Async)");
        }
        

        okhttp3.Call localVarCall = solanaGetWalletTransactionsCall(network, publicKey, _callback);
        return localVarCall;
     ...
     */
    public List<String> solanaGetWalletTransactions(String network, String publicKey) throws ApiException {
        ApiResponse<List<String>> localVarResp = solanaGetWalletTransactionsWithHttpInfo(network, publicKey);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<String>> solanaGetWalletTransactionsWithHttpInfo(String network, String publicKey) throws ApiException {
        okhttp3.Call localVarCall = solanaGetWalletTransactionsValidateBeforeCall(network, publicKey, null);
        Type localVarReturnType = new TypeToken<List<String>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get address&#39;s associated transaction signatures (asynchronously)
     * &lt;a href&#x3D;\&quot;https://github.com/BL0CK-X/blockchain-api/tree/main/examples/solana-wallet/get-wallet-transactions\&quot; target&#x3D;\&quot;_blank\&quot;&gt;See examples (Python, JavaScript)&lt;/a&gt;.      See the transaction signatures of a given public key address  &#x60;Cost: 1 Credits&#x60; (&lt;a href&#x3D;\&quot;#section/Pricing\&quot;&gt;See Pricing&lt;/a&gt;)
     * @param network The network ID (devnet, mainnet-beta) (required)
     * @param publicKey The public key of the account whose list of signatures you want to get (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call solanaGetWalletTransactionsAsync(String network, String publicKey, final ApiCallback<List<String>> _callback) throws ApiException {

        okhttp3.Call localVarCall = solanaGetWalletTransactionsValidateBeforeCall(network, publicKey, _callback);
        Type localVarReturnType = new TypeToken<List<String>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public DoubleTransferResponse solanaTransfer(TransferRequest transferRequest) throws ApiException {
        ApiResponse<DoubleTransferResponse> localVarResp = solanaTransferWithHttpInfo(transferRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<DoubleTransferResponse> solanaTransferWithHttpInfo(TransferRequest transferRequest) throws ApiException {
        okhttp3.Call localVarCall = solanaTransferValidateBeforeCall(transferRequest, null);
        Type localVarReturnType = new TypeToken<DoubleTransferResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call solanaTransferAsync(TransferRequest transferRequest, final ApiCallback<DoubleTransferResponse> _callback) throws ApiException {
