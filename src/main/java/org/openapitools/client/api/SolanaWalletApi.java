...
public class SolanaWalletApi {
     ...
     */
    public okhttp3.Call solanaGetTokensBelongingToWalletCall(String network, String publicKey, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call solanaGetTokensBelongingToWalletValidateBeforeCall(String network, String publicKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = solanaGetTokensBelongingToWalletCall(network, publicKey, _callback);
        return localVarCall;
     ...
     */
    public List<Object> solanaGetTokensBelongingToWallet(String network, String publicKey) throws ApiException {
        ApiResponse<List<Object>> localVarResp = solanaGetTokensBelongingToWalletWithHttpInfo(network, publicKey);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<Object>> solanaGetTokensBelongingToWalletWithHttpInfo(String network, String publicKey) throws ApiException {
        okhttp3.Call localVarCall = solanaGetTokensBelongingToWalletValidateBeforeCall(network, publicKey, null);
     ...
     */
    public okhttp3.Call solanaGetTokensBelongingToWalletAsync(String network, String publicKey, final ApiCallback<List<Object>> _callback) throws ApiException {

        okhttp3.Call localVarCall = solanaGetTokensBelongingToWalletValidateBeforeCall(network, publicKey, _callback);
        Type localVarReturnType = new TypeToken<List<Object>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
