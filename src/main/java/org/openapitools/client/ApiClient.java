...
public class ApiClient {
    ...
    private String basePath = "https://api.theblockchainapi.com/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("APIKeyID", new ApiKeyAuth("header", "APIKeyID"));
        authentications.put("APISecretKey", new ApiKeyAuth("header", "APISecretKey"));
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/null/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.theblockchainapi.com/v1
