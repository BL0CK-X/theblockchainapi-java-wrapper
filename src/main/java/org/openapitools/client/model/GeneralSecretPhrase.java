...
public class GeneralSecretPhrase {
  ...
  public GeneralSecretPhrase() { 
  }

  public GeneralSecretPhrase secretRecoveryPhrase(String secretRecoveryPhrase) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The 12, 15, 18, 21, or 24 word phrase that can be used to derive many public key addresses (e.g., bottom army bless castle alter habit dish embody child flame smooth zone).  To derive a wallet identifier (e.g., public key, public address, etc.), you need a secret recovery phrase, a derivation path, and an optional passphrase.   Alternatively, you can derive a wallet identifier with a private key.  Default Lengths: - Avalanche (C): 24 - Avalanche (X, P): 24 - Binance: 12 - Ethereum: 12 - Near: 12 - Solana: 12  You can use `secret_recovery_phrase` for Chains: `avalanche`, `binance`, `ethereum`, `near`, `solana`.")
  ...
  public boolean equals(Object o) {
    ...
    GeneralSecretPhrase generalSecretPhrase = (GeneralSecretPhrase) o;
    return Objects.equals(this.secretRecoveryPhrase, generalSecretPhrase.secretRecoveryPhrase);
  }

  @Override
  public int hashCode() {
    return Objects.hash(secretRecoveryPhrase);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GeneralSecretPhrase {\n");
