...
public class GetAllNFTsResponseUnminted {
  ...
  public GetAllNFTsResponseUnminted name(String name) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The name of the unminted NFT")
  ...
  public GetAllNFTsResponseUnminted uri(String uri) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The uri of the unminted NFT")
  ...
  public boolean equals(Object o) {
    ...
    GetAllNFTsResponseUnminted getAllNFTsResponseUnminted = (GetAllNFTsResponseUnminted) o;
    return Objects.equals(this.name, getAllNFTsResponseUnminted.name) &&
        Objects.equals(this.uri, getAllNFTsResponseUnminted.uri);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetAllNFTsResponseUnminted {\n");
