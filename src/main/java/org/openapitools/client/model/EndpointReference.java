...
public class EndpointReference {
  ...
  **/
  ...
  public EndpointReference version(String version) {
  ...
  **/
  ...
  public EndpointReference path(String path) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    EndpointReference endpointReference = (EndpointReference) o;
    return Objects.equals(this.projectId, endpointReference.projectId) &&
        Objects.equals(this.version, endpointReference.version) &&
        Objects.equals(this.path, endpointReference.path);
  }

  @Override
  public int hashCode() {
    return Objects.hash(projectId, version, path);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EndpointReference {\n");
