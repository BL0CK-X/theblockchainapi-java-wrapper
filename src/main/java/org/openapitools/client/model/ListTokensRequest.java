...
public class ListTokensRequest {
  public static final String SERIALIZED_NAME_INCLUDE_NFTS = "include_nfts";
  @SerializedName(SERIALIZED_NAME_INCLUDE_NFTS)
  private Boolean includeNfts = false;

  public static final String SERIALIZED_NAME_INCLUDE_ZERO_BALANCE_HOLDINGS = "include_zero_balance_holdings";
  @SerializedName(SERIALIZED_NAME_INCLUDE_ZERO_BALANCE_HOLDINGS)
  private Boolean includeZeroBalanceHoldings = false;


  public ListTokensRequest includeNfts(Boolean includeNfts) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Whether or not to include NFTs in the response")

  public Boolean getIncludeNfts() {
    return includeNfts;
  }


  public void setIncludeNfts(Boolean includeNfts) {
    this.includeNfts = includeNfts;
  }


  public ListTokensRequest includeZeroBalanceHoldings(Boolean includeZeroBalanceHoldings) {
    
    this.includeZeroBalanceHoldings = includeZeroBalanceHoldings;
    return this;
  }
   ...
   * @return includeZeroBalanceHoldings
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether or not to include holdings that have zero balance. This indicates that the wallet held this token or NFT in the past, but no longer holds it.")

  public Boolean getIncludeZeroBalanceHoldings() {
    return includeZeroBalanceHoldings;
  }


  public void setIncludeZeroBalanceHoldings(Boolean includeZeroBalanceHoldings) {
    this.includeZeroBalanceHoldings = includeZeroBalanceHoldings;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.includeNfts, listTokensRequest.includeNfts) &&
        Objects.equals(this.includeZeroBalanceHoldings, listTokensRequest.includeZeroBalanceHoldings);
  }

  @Override
  public int hashCode() {
    return Objects.hash(includeNfts, includeZeroBalanceHoldings);
  }
  ...
  public String toString() {
    ...
    sb.append("    includeNfts: ").append(toIndentedString(includeNfts)).append("\n");
    sb.append("    includeZeroBalanceHoldings: ").append(toIndentedString(includeZeroBalanceHoldings)).append("\n");
    sb.append("}");
    return sb.toString();
  }
