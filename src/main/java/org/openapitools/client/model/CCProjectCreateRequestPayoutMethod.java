 ...
 */
@ApiModel(description = "The method by which we pay out earnings to you. Currently, we only support paying out directly to your Solana wallet. In the future, we will support other wallets and support bank payouts. ")
...
public class CCProjectCreateRequestPayoutMethod {
  ...
  public CCProjectCreateRequestPayoutMethod() { 
  }

  public CCProjectCreateRequestPayoutMethod blockchainIdentifier(String blockchainIdentifier) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The identifier of the wallet that will receive the payments. On Solana, this is your wallet's public key.  ")
  ...
  public boolean equals(Object o) {
    ...
    CCProjectCreateRequestPayoutMethod ccProjectCreateRequestPayoutMethod = (CCProjectCreateRequestPayoutMethod) o;
    return Objects.equals(this.blockchainIdentifier, ccProjectCreateRequestPayoutMethod.blockchainIdentifier);
  }

  @Override
  public int hashCode() {
    return Objects.hash(blockchainIdentifier);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CCProjectCreateRequestPayoutMethod {\n");
