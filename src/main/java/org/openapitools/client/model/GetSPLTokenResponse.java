...
public class GetSPLTokenResponse {
  ...
  public static final String SERIALIZED_NAME_FREEZE_AUTHORITY = "freeze_authority";
  @SerializedName(SERIALIZED_NAME_FREEZE_AUTHORITY)
  private String freezeAuthority;

  public static final String SERIALIZED_NAME_MINT_AUTHORITY = "mint_authority";
  @SerializedName(SERIALIZED_NAME_MINT_AUTHORITY)
  private String mintAuthority;

  public static final String SERIALIZED_NAME_IS_INITIALIZED = "is_initialized";
  ...
  **/
  ...
  @ApiModelProperty(value = "The number of decimals of the token. For example, if the USDC token has 6 decimals, then you need 1 * 10e6 = 1,000,000 tokens to have 1 USDC. The purpose of this is that everything must be stored as  an integer. Thus, if there are $100 USDC in total, there must be $100 * 10e6 tokens in order for the $100 to be divisible into lower denominations than $1. ")
  ...
  public GetSPLTokenResponse freezeAuthority(String freezeAuthority) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Public key address")
  ...
  public GetSPLTokenResponse mintAuthority(String mintAuthority) {
  ...
  **/
  ...
  public GetSPLTokenResponse isInitialized(Boolean isInitialized) {
  ...
  **/
  ...
  public GetSPLTokenResponse supply(String supply) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The supply of the token")
  ...
  public boolean equals(Object o) {
    ...
    GetSPLTokenResponse getSPLTokenResponse = (GetSPLTokenResponse) o;
    return Objects.equals(this.decimals, getSPLTokenResponse.decimals) &&
        Objects.equals(this.freezeAuthority, getSPLTokenResponse.freezeAuthority) &&
        Objects.equals(this.mintAuthority, getSPLTokenResponse.mintAuthority) &&
        Objects.equals(this.isInitialized, getSPLTokenResponse.isInitialized) &&
        Objects.equals(this.supply, getSPLTokenResponse.supply);
  }

  @Override
  public int hashCode() {
    return Objects.hash(decimals, freezeAuthority, mintAuthority, isInitialized, supply);
  }
  ...
  public String toString() {
    ...
    sb.append("    freezeAuthority: ").append(toIndentedString(freezeAuthority)).append("\n");
    sb.append("    mintAuthority: ").append(toIndentedString(mintAuthority)).append("\n");
