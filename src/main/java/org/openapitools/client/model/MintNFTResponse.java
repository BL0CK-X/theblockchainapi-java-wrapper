...
public class MintNFTResponse {
  ...
  public MintNFTResponse taskId(String taskId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The task ID of the task launched to complete the request")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.taskId, mintNFTResponse.taskId);
  }
