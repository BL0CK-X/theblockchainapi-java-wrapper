...
public class ATAResponse {
  public static final String SERIALIZED_NAME_ASSOCIATED_TOKEN_ADDRESS = "associated_token_address";
  @SerializedName(SERIALIZED_NAME_ASSOCIATED_TOKEN_ADDRESS)
  private String associatedTokenAddress;


  public ATAResponse associatedTokenAddress(String associatedTokenAddress) {
    
    this.associatedTokenAddress = associatedTokenAddress;
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The associated token address")

  public String getAssociatedTokenAddress() {
    return associatedTokenAddress;
  }


  public void setAssociatedTokenAddress(String associatedTokenAddress) {
    this.associatedTokenAddress = associatedTokenAddress;
  }
  ...
  public boolean equals(Object o) {
    ...
    ATAResponse atAResponse = (ATAResponse) o;
    return Objects.equals(this.associatedTokenAddress, atAResponse.associatedTokenAddress);
  }

  @Override
  public int hashCode() {
    return Objects.hash(associatedTokenAddress);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ATAResponse {\n");
    sb.append("    associatedTokenAddress: ").append(toIndentedString(associatedTokenAddress)).append("\n");
    sb.append("}");
    return sb.toString();
  }
