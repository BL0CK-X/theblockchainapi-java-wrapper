...
public class Task {
  ...
  public static final String SERIALIZED_NAME_TIME_COMPLETED = "time_completed";
  @SerializedName(SERIALIZED_NAME_TIME_COMPLETED)
  private BigDecimal timeCompleted;
  ...
  public Task response(Object response) {
  ...
  **/
  ...
  public Task timeCompleted(BigDecimal timeCompleted) {
  ...
  **/
  ...
  public BigDecimal getTimeCompleted() {
    return timeCompleted;
  }


  public void setTimeCompleted(BigDecimal timeCompleted) {
    this.timeCompleted = timeCompleted;
  }


  public Task statusCode(BigDecimal statusCode) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Task task = (Task) o;
    return Objects.equals(this.response, task.response) &&
        Objects.equals(this.timeCompleted, task.timeCompleted) &&
        Objects.equals(this.statusCode, task.statusCode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(response, timeCompleted, statusCode);
  }
