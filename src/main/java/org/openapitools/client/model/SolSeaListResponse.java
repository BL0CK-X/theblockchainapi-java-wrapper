...
public class SolSeaListResponse {
  ...
  public SolSeaListResponse transactionSignature(String transactionSignature) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The signature of the `list` transaction ")
  ...
  public boolean equals(Object o) {
    ...
    SolSeaListResponse solSeaListResponse = (SolSeaListResponse) o;
    return Objects.equals(this.transactionSignature, solSeaListResponse.transactionSignature);
  }
  ...
  public String toString() {
    ...
    sb.append("class SolSeaListResponse {\n");
