...
public class GetMintedNFTsRequest {
  ...
  public GetMintedNFTsRequest candyMachineId(String candyMachineId) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The ID of the candy machine")
  ...
  public GetMintedNFTsRequest network(NetworkEnum network) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetMintedNFTsRequest getMintedNFTsRequest = (GetMintedNFTsRequest) o;
    return Objects.equals(this.candyMachineId, getMintedNFTsRequest.candyMachineId) &&
        Objects.equals(this.network, getMintedNFTsRequest.network);
  }

  @Override
  public int hashCode() {
    return Objects.hash(candyMachineId, network);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetMintedNFTsRequest {\n");
