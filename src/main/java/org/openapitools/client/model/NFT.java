...
public class NFT {
  ...
  public NFT confirmed(Boolean confirmed) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Whether or not the NFT mint was confirmed or simply submitted for processing. The status depends on your input for `wait_for_confirmation`. This only is returned when you are minting an NFT, not when searching or retrieving the metadata.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    NFT NFT = (NFT) o;
    return Objects.equals(this.confirmed, NFT.confirmed) &&
        Objects.equals(this.data, NFT.data) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(confirmed, data, isMutable, mint, primarySaleHappened, updateAuthority, sellerFeeBasisPoints, mintSecretRecoveryPhrase, explorerUrl, metadataAccount, editionNonce, tokenStandard, collection, uses);
  }
