...
public class GetConfigInfoRequest {
  ...
  public GetConfigInfoRequest configAddress(String configAddress) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The config address of the candy machine.  If you don't know the address of a candy machine, you can use the \"Get Candy Machine Details\" endpoint to get the configuration public key address.  If you don't know the candy machine ID to call this endpoint, you can find it with the \"Get NFT's Candy Machine ID\" endpoint. ")
  ...
  public GetConfigInfoRequest network(NetworkEnum network) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetConfigInfoRequest getConfigInfoRequest = (GetConfigInfoRequest) o;
    return Objects.equals(this.configAddress, getConfigInfoRequest.configAddress) &&
        Objects.equals(this.network, getConfigInfoRequest.network);
  }

  @Override
  public int hashCode() {
    return Objects.hash(configAddress, network);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetConfigInfoRequest {\n");
