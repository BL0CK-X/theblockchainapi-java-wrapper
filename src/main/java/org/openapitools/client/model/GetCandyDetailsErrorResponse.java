...
public class GetCandyDetailsErrorResponse {
  public static final String SERIALIZED_NAME_ERROR = "error";
  @SerializedName(SERIALIZED_NAME_ERROR)
  private String error;


  public GetCandyDetailsErrorResponse error(String error) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetCandyDetailsErrorResponse getCandyDetailsErrorResponse = (GetCandyDetailsErrorResponse) o;
    return Objects.equals(this.error, getCandyDetailsErrorResponse.error);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetCandyDetailsErrorResponse {\n");
