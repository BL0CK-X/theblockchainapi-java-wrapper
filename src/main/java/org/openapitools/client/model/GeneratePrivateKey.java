...
public class GeneratePrivateKey {
  ...
  public GeneratePrivateKey privateKey(Object privateKey) {
  ...
  **/
  ...
  @ApiModelProperty(value = "A private key corresponds to exactly one public key address. A private key can be used to move assets out of the wallet and sign transaction with the corresponding public key.  A private key is an array of integers (e.g.,   `[185,108,153,165,57,193,166,167,58,148,133,121,92,252,242,13,233,246,35,103,185,20,27,56,111,169,12,50,50,36,83,156,173,195,143,75,135,78,204,129,217,231,58,129,69,180,185,86,119,43,200,193,94,112,31,135,68,128,207,26,85,150,68,181]`).  <a href=\"https://solflare.com\" target=\"_blank\">Solflare</a> is a popular wallet interface on Solana that allows you to export your private key in this format.")
  ...
  public GeneratePrivateKey b58PrivateKey(String b58PrivateKey) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GeneratePrivateKey generatePrivateKey = (GeneratePrivateKey) o;
    return Objects.equals(this.privateKey, generatePrivateKey.privateKey) &&
        Objects.equals(this.b58PrivateKey, generatePrivateKey.b58PrivateKey);
  }

  @Override
  public int hashCode() {
    return Objects.hash(privateKey, b58PrivateKey);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GeneratePrivateKey {\n");
