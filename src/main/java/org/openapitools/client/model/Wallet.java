 ...
 */
@ApiModel(description = "The wallet authentication information required to sign transactions.  Click the `>` arrow next to \"wallet\" on the left to see more details. See our Security section <a href=\"#section/Security\">here</a>. ")
