...
import org.openapitools.client.model.GeneralSecretRecoveryPhrase;
 ...
 */
@ApiModel(description = "This feature is only supported for `solana`.  If you do NOT provide a wallet here, the fee payer of the transaction will be the `wallet` you provide or the `sender_blockchain_identifier`.        If you do provide a wallet, then the `fee_payer_wallet` will pay the fees of the transaction and any costs associated with creating a new associated token account (only if necessary; approx. 0.002 SOL when necessary). A new account is necessary if you are sending an NFT or SPL token to a user that has not received the same NFT or one of the SPL tokens before (thus, a new associated token account is needed).")
...
public class GeneralFeePayerWallet {
  ...
  public GeneralFeePayerWallet() { 
  }

  public GeneralFeePayerWallet secretRecoveryPhrase(String secretRecoveryPhrase) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The 12, 15, 18, 21, or 24 word phrase that can be used to derive many public key addresses (e.g., bottom army bless castle alter habit dish embody child flame smooth zone).  To derive a wallet identifier (e.g., public key, public address, etc.), you need a secret recovery phrase, a derivation path, and an optional passphrase.   Alternatively, you can derive a wallet identifier with a private key.  Default Lengths: - Avalanche (C): 24 - Avalanche (X, P): 24 - Binance: 12 - Ethereum: 12 - Near: 12 - Solana: 12  You can use `secret_recovery_phrase` for Chains: `avalanche`, `binance`, `ethereum`, `near`, `solana`.")
  ...
  public GeneralFeePayerWallet derivationPath(String derivationPath) {
  ...
  **/
  ...
  public GeneralFeePayerWallet passphrase(String passphrase) {
  ...
  **/
  ...
  public GeneralFeePayerWallet hexPrivateKey(String hexPrivateKey) {
  ...
  **/
  ...
  public GeneralFeePayerWallet privateKey(Object privateKey) {
  ...
  **/
  ...
  public GeneralFeePayerWallet b58PrivateKey(String b58PrivateKey) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GeneralFeePayerWallet generalFeePayerWallet = (GeneralFeePayerWallet) o;
    return Objects.equals(this.secretRecoveryPhrase, generalFeePayerWallet.secretRecoveryPhrase) &&
        Objects.equals(this.derivationPath, generalFeePayerWallet.derivationPath) &&
        Objects.equals(this.passphrase, generalFeePayerWallet.passphrase) &&
        Objects.equals(this.hexPrivateKey, generalFeePayerWallet.hexPrivateKey) &&
        Objects.equals(this.privateKey, generalFeePayerWallet.privateKey) &&
        Objects.equals(this.b58PrivateKey, generalFeePayerWallet.b58PrivateKey);
  }

  @Override
  public int hashCode() {
    return Objects.hash(secretRecoveryPhrase, derivationPath, passphrase, hexPrivateKey, privateKey, b58PrivateKey);
  }
