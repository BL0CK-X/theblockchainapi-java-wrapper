...
public class BalanceRequest {
  ...
  private UnitEnum unit = UnitEnum.LAMPORT;
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The public key address of the wallet")
  ...
  public BalanceRequest unit(UnitEnum unit) {
  ...
  **/
  ...
  @ApiModelProperty(value = "If you are retrieving the SOL balance, you can select whether to retrieve this in SOL or Lamport units (1 SOL = 1e9 Lamports).")
  ...
  public BalanceRequest network(NetworkEnum network) {
  ...
  **/
  ...
  public BalanceRequest mintAddress(String mintAddress) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The mint address of the SPL token. If not provided, the balance returned is in SOL. Make sure to use the correct network.  Some example mint addresses: - USDC: EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v - Mango: MangoCzJ36AjZyKwVj3VnYU4GTonjfVEnJmvvWaxLac - Serum: SRMuApVNdxXokk5GT7XD5cUUgXMBCoAz2LHeuAoKWRt - Raydium: 4k3Dyjzvzp8eMZWUXbBCjEvwSkkk59S5iCNLY3QrkX6R - wSOL: So11111111111111111111111111111111111111112 - ATLAS: ATLASXmbPQxBUYbxPsV97usA3fPQYEqzQBUHgiFCUsXx")
  ...
  public boolean equals(Object o) {
    ...
    BalanceRequest balanceRequest = (BalanceRequest) o;
    return Objects.equals(this.publicKey, balanceRequest.publicKey) &&
        Objects.equals(this.unit, balanceRequest.unit) &&
        Objects.equals(this.network, balanceRequest.network) &&
        Objects.equals(this.mintAddress, balanceRequest.mintAddress);
  }

  @Override
  public int hashCode() {
    return Objects.hash(publicKey, unit, network, mintAddress);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BalanceRequest {\n");
