 ...
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2021-12-05T16:57:52.537705-08:00[America/Los_Angeles]")
public class GetAllNFTsResponseMinted {
  ...
  public static final String SERIALIZED_NAME_PUB_KEY_HASH = "pub_key_hash";
  @SerializedName(SERIALIZED_NAME_PUB_KEY_HASH)
  private String pubKeyHash;


  public GetAllNFTsResponseMinted nftMetadata(NFT nftMetadata) {
  ...
  **/
  ...
  public NFT getNftMetadata() {
    return nftMetadata;
  }


  public void setNftMetadata(NFT nftMetadata) {
    this.nftMetadata = nftMetadata;
  }


  public GetAllNFTsResponseMinted pubKeyHash(String pubKeyHash) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Use this to verify the NFT")
  ...
  public boolean equals(Object o) {
    ...
    GetAllNFTsResponseMinted getAllNFTsResponseMinted = (GetAllNFTsResponseMinted) o;
    return Objects.equals(this.nftMetadata, getAllNFTsResponseMinted.nftMetadata) &&
        Objects.equals(this.pubKeyHash, getAllNFTsResponseMinted.pubKeyHash);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nftMetadata, pubKeyHash);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetAllNFTsResponseMinted {\n");
    sb.append("    nftMetadata: ").append(toIndentedString(nftMetadata)).append("\n");
    sb.append("    pubKeyHash: ").append(toIndentedString(pubKeyHash)).append("\n");
    sb.append("}");
    return sb.toString();
  }
