...
public class GetCandyMachineIDRequest {
  ...
  public GetCandyMachineIDRequest() { 
  }

  public GetCandyMachineIDRequest mintAddress(String mintAddress) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The address of the NFT. NOT the mint authority address")
  ...
  public GetCandyMachineIDRequest network(NetworkEnum network) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetCandyMachineIDRequest getCandyMachineIDRequest = (GetCandyMachineIDRequest) o;
    return Objects.equals(this.mintAddress, getCandyMachineIDRequest.mintAddress) &&
        Objects.equals(this.network, getCandyMachineIDRequest.network);
  }

  @Override
  public int hashCode() {
    return Objects.hash(mintAddress, network);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetCandyMachineIDRequest {\n");
